const Content = () => {
  return (
    <div className="w-full bg-[#F9F9F3] text-zinc-900 border-t border-zinc-300 mt-10 px-4 py-8 sm:px-6 sm:py-10 grid gap-8 md:grid-cols-2 lg:grid-cols-3 text-sm overflow-hidden">
      {/* Quick Links Section */}
